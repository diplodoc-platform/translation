...
export class CustomRenderer<State = {}, Md extends MarkdownIt = MarkdownIt> extends Renderer {
    ...
    constructor({
        ...
        rules = {},
        state = {} as State,
    }: CustomRendererParams<State>, parser: Md) {
        super();
    ...
    // @ts-ignore
    renderInline(tokens: Token[], options: Options, env: unknown, map: SourceMap | null, inline: Token) {
...
export function customRenderer<State = {}, Md extends MarkdownIt = MarkdownIt>(parser: Md, parameters: CustomRendererParams<State> = {}) {
    // @ts-ignore
